    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-8 px-4">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-2">Todo App</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            />
            <button
              onClick={addTodo}
        ...
        <div className="space-y-3">
          {todos.length === 0 ? (
            <div className="text-center py-12">
              ...
              <div className="text-gray-500 dark:text-gray-400 text-sm">Add a task above to get started!</div>
            </div>
          ) : (
            todos.map((todo) => (
              <div
        ...
        {completedCount > 0 && (
          <div className="mt-6 text-center">
            <button
              ...
              className="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
            >
